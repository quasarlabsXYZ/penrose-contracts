...
func display_array_elements{syscall_ptr: felt*, range_check_ptr, pedersen_ptr: HashBuiltin*}(
    resstr_len: felt, resstr: felt*
) {
    if (resstr_len == 0) {
        return ();
    }
...
@external
func test_price_decay_above_target_rate{
...
@external
func test_price_decay_below_target_rate{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
...
@external
func test_price_increase_above_target_rate{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
...
@external
func test_price_increase_below_target_rate{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
...
func test_mint{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    ...
    let pre_balance_of2: Uint256 = IERC20.balanceOf(
        ETH, 0x509019d5d5a1cac289753dab67650a7081f29002a1b7790fd2311104d5af194
    );
    ...
    let post_balance_of2: Uint256 = IERC20.balanceOf(
        ETH, 0x509019d5d5a1cac289753dab67650a7081f29002a1b7790fd2311104d5af194
    );
    %{
        close_user_1()
