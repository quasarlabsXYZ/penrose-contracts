...
from imx_starknet.immutablex.starknet.token.erc721_token_metadata.library import (
    ERC721_Token_Metadata,
)
from imx_starknet.immutablex.starknet.token.erc721_contract_metadata.library import (
...
@view
func getIdToSeed{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(id: felt) -> (
    seed: felt
) {
...
func getSeedToId{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(seed: felt) -> (
    id: felt
) {
...
func getIdToScheme{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(id: felt) -> (
    scheme: felt
) {
...
@view
func getNumToken{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    num_token: felt
) {
...
@view
func getTotalSupply{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    supply: felt
) {
...
func get_color_scheme{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    scheme: felt
) -> (color_scheme: felt) {
    alloc_locals;
...
func append_to_felt{
    bitwise_ptr: BitwiseBuiltin*, syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}(res: felt, new_char: felt) -> (is_new: felt, new_str: felt) {
    alloc_locals;
...
func for_each_row{
    ...
    i: felt, token_id: felt, output_len: felt, output: felt*, mod: felt, seed: felt, scheme: felt
) -> (res_len: felt, res: felt*) {
    alloc_locals;
    if (i == SIZE) {
        return (i * 2, output);
...
func add_line{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    i: felt,
    pos: felt,
    step: felt,
    uri_len: felt,
    uri: felt*,
    token_raw_uri_len: felt,
    token_raw_uri: felt*,
) -> (res_uri_len: felt, res_uri: felt*) {
    alloc_locals;
    if (i == SIZE) {
        return (uri_len, uri);
    }
...
func wrap_to_svg{
    bitwise_ptr: BitwiseBuiltin*, syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}(token_id: felt, num: felt, color_scheme: felt) -> (res_uri_len: felt, res_uri: felt*) {
    alloc_locals;
    ...
    let (s_len: felt, s: felt*) = add_line(
        i, start, step, 162, uri, token_raw_uri_len + 1, token_raw_uri
    );
...
@view
func getCurrentEMS{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    result: felt
) {
    alloc_locals;
...
func getQuote{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (result: felt) {
    ...
    local is_before: felt = is_le(block_number, price_decay_start_block);
...
@view
func getNextStartingPrice{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    lastPurchasePrice: felt
) -> (result: felt) {
    alloc_locals;
    local result: felt;
    ...
    local is_before: felt = is_le(mismatchRatio, FP_ONE);
...
@view
func getPriceDecayStartBlock{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    result: felt
) {
    alloc_locals;
    local result: felt;
    ...
    let (local mismatchRatio: felt) = Math64x61_div(next_purchase_starting_ems, target_ems);
    local mmr_over_one: felt = is_le(mismatchRatio, FP_ONE);
    let (block_number: felt) = get_block_number();
...
@view
func getSaleHalfLife{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    i: felt
) {
...
@view
func getPriceHalfLife{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    i: felt
) {
...
@view
func getNextPurchaseStartingEMS{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ) -> (i: felt) {
...
@view
func getNextPurchaseStartingPrice{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ) -> (i: felt) {
...
@view
func getPurchasePrice{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    id: felt
) -> (price: felt) {
...
@view
func getPurchaseBlock{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    id: felt
) -> (block: felt) {
